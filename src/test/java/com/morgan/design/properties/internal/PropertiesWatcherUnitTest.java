...
public class PropertiesWatcherUnitTest {
	...
	final File propertiesFile1 = new File(
			"target/test-classes/test-files/fileWatcher.properties");
	final File propertiesFile2 = new File(
			"target/test-classes/test-files/different_fileWatcher.properties");
	final File propertiesFile3 = new File(
			"target/test-classes/test-files2/fileWatcher2.properties");

	final Resource[] singleResource = new Resource[] { new FileSystemResource(
			this.propertiesFile1) };
	final Resource[] multiResourceSameDir = new Resource[] {
			new FileSystemResource(this.propertiesFile1),
			new FileSystemResource(this.propertiesFile2) };
	final Resource[] multiResourceDifferentDir = new Resource[] {
			new FileSystemResource(this.propertiesFile1),
			new FileSystemResource(this.propertiesFile3) };

	@Test
	public final void testWatchingASingle() throws IOException,
	...
	@Test
	public final void testWatchingMulitipleResourcesInDifferingDirectories()
	...
	@Test
	public final void testModifyingADifferentResoruceInSameDirectory()
			throws IOException, InterruptedException {
	...
	private void startPropertiesWatcher(
			final PropertiesWatcher propertiesWatcher) {
	...
	private PropertiesWatcher createPropertiesWatcher(final Resource[] resources)
			throws IOException {
		final PropertiesWatcher propertiesWatcher = new PropertiesWatcher(
				resources, new EventPublisher() {
					@Override
